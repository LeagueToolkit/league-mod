...
## [0.5.1](https://github.com/LeagueToolkit/league-mod/compare/ltk_modpkg-v0.5.0...ltk_modpkg-v0.5.1) - 2026-07-02

### Added

- *(ltk_modpkg)* improve compression coverage and dedup identical chunks
