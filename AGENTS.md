...
This file provides guidance to coding agents (Claude Code, Codex, and others) when working with code in this repository. Repository-specific skills live under `.claude/skills/`; an agent without a skills loader reads the `SKILL.md` there directly.
